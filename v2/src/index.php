      ...
      <p style="margin: 20px;"></p>
        <div class="form">
          <div class="form-group">
            <button class="btn btn-lg btn-primary" style="width:70%" id="loadmorebutton">Load More Offerings</button> <img src="../img/gif-load.gif" alt="" id="loadingimg" style="display:none;">
          </div>
        </div>
      </div>
    </div>
