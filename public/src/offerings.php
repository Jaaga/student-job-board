<?php 
	...
	class offering{
		...
		public function get_offering_by_user_id($user_id,$item_num)
		{
		...
		public function get_offering_by_category($category_id, $item_num,){
		...
		public function create_offering($user_id,$title,$description,$picture)
		{
			...
			$sql_query = "INSERT INTO offering(user_id, title, description, picture, date) VALUES ('$user_id', '$title', '$description', '$picture', Now())";
		}
		...
		public function update_offering($user_id,$offer_id,$title,$description,$picture)
		{
			...
			$sql_query = "UPDATE offering SET title = $title, description = $description, picture = $picture WHERE offer_id = $offer_id AND user_id = $user_id";
		}
		...
		public function delete_offering($user_id,$offer_id)
		{
			...
			$sql_query = "DELETE FROM offering WHERE user_id = $user_id AND offer_id = $user_id";
		}
